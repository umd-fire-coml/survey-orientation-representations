...
python3 training.py --predict rot-y --converter multibin --batch_size 25 --epoch 100 --kitti_dir "/home/siyuan/dataset/kitti" --training_record "/home/siyuan/fire/KITTI-Orientation/multibin"
